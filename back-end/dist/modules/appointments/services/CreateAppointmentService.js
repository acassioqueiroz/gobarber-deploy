...
let CreateAppointmentService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    if ((0, _dateFns.isBefore)(appointmentDate, Date.now())) {
      throw new _AppError.default("You can't create an appointment in a past date");
    }
    ...
    const hourOfAppointment = (0, _dateFns.getHours)(appointmentDate);

    if (hourOfAppointment < 8 || hourOfAppointment > 17) {
      throw new _AppError.default('You can only create an appointment between 8am and 17pm');
    }
